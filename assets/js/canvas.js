...
// тут необхідно додати код очистки canvas та масиву точок (clearRect)
    ...
    backgroundChange.addEventListener('click', () => {
        const img = new Image;
        img.src =`https://images.ua.prom.st/2553927771_kartina-po-nomeram.jpg)`;
        img.onload = () => {
    ...
    time.innerHTML = '<img src="assets/img/clock.png" height="35px" width="35px" />';
    save.innerHTML = '<img src="assets/img/save.png" height="35px" width="35px" />';
    clearBtn.innerHTML = '<img src="assets/img/clear.png" height="30px" width="30px" />';
    download.innerHTML = '<img src="assets/img/download.png" height="35px" width="35px" />';
    restore.innerHTML = '<img src="assets/img/restore.png" height="35px" width="35px" />';
    backgroundChange.innerHTML = '<img src="assets/img/image.png" height="35px" width="35px" />';
